...
curl -L -o balgrist-sci.zip https://github.com/sct-pipeline/balgrist-sci/archive/refs/tags/r20250612.zip
# Unzip the downloaded file --> the unzipped directory will be named balgrist-sci-r20250612
unzip balgrist-sci.zip
rm balgrist-sci.zip
# Rename the unzipped directory to balgrist-sci
mv balgrist-sci-r20250612 balgrist-sci
